...
public class HCServiceResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<HCService>> getAllHCServices(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of HCServices");
        Page<HCService> page = hCServiceRepository.findAll(pageable);
