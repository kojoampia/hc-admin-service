...
public class FeatureResource {
    ...
    public ResponseEntity<FeatureDTO> createFeature(@Valid @RequestBody FeatureDTO featureDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/features/" + featureDTO.getId()))
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<FeatureDTO>> getAllFeatures(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
