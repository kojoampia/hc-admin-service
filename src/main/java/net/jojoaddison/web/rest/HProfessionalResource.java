...
public class HProfessionalResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<HProfessional>> getAllHProfessionals(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of HProfessionals");
        Page<HProfessional> page = hProfessionalRepository.findAll(pageable);
