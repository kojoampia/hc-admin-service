...
public class HCSubscriptionResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<HCSubscription>> getAllHCSubscriptions(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of HCSubscriptions");
        Page<HCSubscription> page = hCSubscriptionRepository.findAll(pageable);
