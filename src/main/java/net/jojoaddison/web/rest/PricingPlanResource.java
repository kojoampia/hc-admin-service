...
public class PricingPlanResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<PricingPlanDTO>> getAllPricingPlans(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        LOG.debug("REST request to get a page of PricingPlans");
        Page<PricingPlanDTO> page = pricingPlanService.findAll(pageable);
