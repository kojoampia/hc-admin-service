...
public class HubResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Hub>> getAllHubs(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        LOG.debug("REST request to get a page of Hubs");
        Page<Hub> page = hubRepository.findAll(pageable);
