...
public class ServicePlanTestSamples {
    ...
    public static ServicePlan getServicePlanSample1() {
        return new ServicePlan().id("id1").name("name1").tierLabel("tierLabel1").currency("currency1").summary("summary1");
    }

    public static ServicePlan getServicePlanSample2() {
        return new ServicePlan().id("id2").name("name2").tierLabel("tierLabel2").currency("currency2").summary("summary2");
    }
