...
class DashboardResourceIT {
    ...
    private static final String DEFAULT_ELEMENTS = "AAAAAAAAAA";
    private static final String UPDATED_ELEMENTS = "BBBBBBBBBB";
    ...
    public static Dashboard createEntity() {
        Dashboard dashboard = new Dashboard().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).elements(DEFAULT_ELEMENTS);
        return dashboard;
    }
    ...
    public static Dashboard createUpdatedEntity() {
        Dashboard dashboard = new Dashboard().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).elements(UPDATED_ELEMENTS);
        return dashboard;
    }
    ...
    void createDashboard() throws Exception {
        ...
        assertThat(testDashboard.getElements()).isEqualTo(DEFAULT_ELEMENTS);
    }
    ...
    void getAllDashboards() throws Exception {
        ...
        restDashboardMockMvc
            ...
            .andExpect(jsonPath("$.[*].elements").value(hasItem(DEFAULT_ELEMENTS)));
    }
    ...
    void getDashboard() throws Exception {
        ...
        restDashboardMockMvc
            ...
            .andExpect(jsonPath("$.elements").value(DEFAULT_ELEMENTS));
    }
    ...
    void putExistingDashboard() throws Exception {
        ...
        updatedDashboard.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).elements(UPDATED_ELEMENTS);
        ...
        assertThat(testDashboard.getElements()).isEqualTo(UPDATED_ELEMENTS);
    }
    ...
    void partialUpdateDashboardWithPatch() throws Exception {
        ...
        partialUpdatedDashboard.description(UPDATED_DESCRIPTION).elements(UPDATED_ELEMENTS);
    ...
    void fullUpdateDashboardWithPatch() throws Exception {
        ...
        partialUpdatedDashboard.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).elements(UPDATED_ELEMENTS);
