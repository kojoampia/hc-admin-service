...
description: 'Use for hc-admin-ms backend workflows that add or modify endpoint, service, repository, and integration tests as one cohesive slice in this JHipster Spring MVC microservice.'
