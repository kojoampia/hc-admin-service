---
description: 'Use when writing, reviewing, or updating Java tests in hc-admin-ms. Covers IntegrationTest setup, MockMvc CRUD assertions, repository-count helpers, and architecture/security test boundaries.'
