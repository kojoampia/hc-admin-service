---
description: 'Use when creating or modifying REST controllers, services, or repositories in hc-admin-ms. Covers JHipster CRUD flow, id validation, partial update mapping, and repository boundaries.'
